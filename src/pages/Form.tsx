...
export const Form = () => {
    ...
    const onSubmit = (data: any) => {
        console.log(data)
        navigate(`/firebase/Generate/${data.field1t}/${data.field2t}/${data.name}/${data.field1}/${data.field2}`)
    }
    ...
    return (
        <div>
            ...
            <form className="contactForm" onSubmit={handleSubmit(onSubmit)}  >
                <h1>
                    <img alt="a" id="hrtLogo" src="https://raw.githubusercontent.com/dependabot-pr/Static-Files/30a9957af65afeecf3f2430f92a09706952b4056/Assets/Logo/Technologies/Firebase.svg" draggable="false" />
                    <span className='mr-5'></span> Firebase
                </h1>
